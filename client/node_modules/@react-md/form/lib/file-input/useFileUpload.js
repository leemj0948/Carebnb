...
function useFileUpload(_a) {
    var _b = _a === void 0 ? {} : _a, _c = _b.maxFiles, maxFiles = _c === void 0 ? -1 : _c, _d = _b.extensions, extensions = _d === void 0 ? DEFAULT_EXTENSIONS : _d, _e = _b.minFileSize, minFileSize = _e === void 0 ? -1 : _e, _f = _b.maxFileSize, maxFileSize = _f === void 0 ? -1 : _f, _g = _b.totalFileSize, totalFileSize = _g === void 0 ? -1 : _g, _h = _b.concurrency, concurrency = _h === void 0 ? -1 : _h, propOnDrop = _b.onDrop, propOnChange = _b.onChange, _j = _b.validateFiles, validateFiles = _j === void 0 ? utils_2.validateFiles : _j, _k = _b.getFileParser, getFileParser = _k === void 0 ? utils_2.getFileParser : _k;
    var _l = react_1.useReducer(function reducer(state, action) {
        var _a, _b, _c, _d;
        switch (action.type) {
            case "reset":
                return {
            ...
            case "queue":
                return __assign(__assign({}, state), { stats: __assign(__assign({}, state.stats), action.files.reduce(function (files, file) {
                        ...
                        return files;
                    }, {})), errors: __spreadArray(__spreadArray([], state.errors), action.errors) });
            case "start": {
    ...
    var queueFiles = react_1.useCallback(function (files) {
    ...
    var onDrop = react_1.useCallback(function (event) {
        ...
        try {
            ...
            dispatch({
                type: "queue",
                files: [],
                errors: [new utils_2.FileAccessError(e)],
            });
        }
    ...
    var remove = react_1.useCallback(function (keyOrKeys) {
    ...
    var start = react_1.useCallback(function (key, reader) {
        dispatch({ type: "start", key: key, reader: reader });
    }, []);
    var complete = react_1.useCallback(function (key, result) {
        if (result === void 0) { result = null; }
        dispatch({ type: "complete", key: key, result: result });
    }, []);
    var createProgressEventHandler = react_1.useCallback(function (key) { return function (event) {
