...
function validateFiles(files, _a) {
    var maxFiles = _a.maxFiles, extensions = _a.extensions, minFileSize = _a.minFileSize, maxFileSize = _a.maxFileSize, totalBytes = _a.totalBytes, totalFiles = _a.totalFiles, totalFileSize = _a.totalFileSize;
    var errors = [];
    var pending = [];
    var extraFiles = [];
    var nameRegExp = extensions.length > 0
    ...
    for (var i = 0; i < files.length; i += 1) {
        ...
        if (nameRegExp && !nameRegExp.test(name_1)) {
            valid = false;
