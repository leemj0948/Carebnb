...
var styles = utils_1.bem("rmd-toggle");
/**
 * @remarks \@since 2.8.0
 */
exports.InputToggleIcon = react_1.forwardRef(function InputToggleIcon(_a, ref) {
    ...
    return (react_1.default.createElement("span", __assign({}, props, { ref: ref, className: classnames_1.default(styles("icon", {
            circle: circle,
            disabled: disabled,
            overlay: overlay,
