 ...
 * second argument.
 */
export declare function useIndeterminateChecked<V extends string>(values: readonly V[], defaultCheckedValues: Initializer<V>, onChange?: OnChange<V>): OnChangeReturnValue<V>;
