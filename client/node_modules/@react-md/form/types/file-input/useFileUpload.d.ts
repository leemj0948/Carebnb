 ...
 * @remarks \@since 2.9.0
 */
export declare function useFileUpload<E extends HTMLElement, CustomError = never>({ maxFiles, extensions, minFileSize, maxFileSize, totalFileSize, concurrency, onDrop: propOnDrop, onChange: propOnChange, validateFiles, getFileParser, }?: FileUploadOptions<E, CustomError>): FileUploadHookReturnValue<E, CustomError>;
