 ...
 * @remarks \@since 2.9.0
 */
export declare function validateFiles<CustomError>(files: readonly File[], { maxFiles, extensions, minFileSize, maxFileSize, totalBytes, totalFiles, totalFileSize, }: FilesValidationOptions): ValidatedFilesResult<CustomError>;
/**
