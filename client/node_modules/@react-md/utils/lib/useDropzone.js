...
function useDropzone(options) {
    ...
    var _a = react_1.useState(false), isOver = _a[0], setOver = _a[1];
    var onDragOver = react_1.useCallback(function (event) {
        propOnDragOver === null || propOnDragOver === void 0 ? void 0 : propOnDragOver(event);
        event.preventDefault();
        event.stopPropagation();
        setOver(true);
    }, [propOnDragOver]);
    var onDragEnter = react_1.useCallback(function (event) {
    ...
    var onDragLeave = react_1.useCallback(function (event) {
