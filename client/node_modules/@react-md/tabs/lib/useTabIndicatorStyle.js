...
function useTabIndicatorStyle(_a) {
    ...
    var updateStyles = react_1.useCallback(function () {
        updateCSSVars(itemRefs, activeIndex);
    ...
    var _c = utils_1.useResizeObserver(updateStyles, {
        ref: propRef,
    }), tabsRef = _c[0], tabsRefHandler = _c[1];
    var mergedStyle = react_1.useMemo(function () { return (__assign(__assign({}, style), cssVars)); }, [style, cssVars]);
