...
function useTreeMovement(_a) {
    ...
    var items = useNestedTreeList_1.useNestedTreeList(data, sort, rootId);
    var _b = useFlattenedTreeList_1.useFlattenedTreeList({
        id: id,
        items: items,
    ...
    var _c = utils_1.useActiveDescendantMovement(__assign(__assign({}, utils_1.MovementPresets.VERTICAL_TREE), { items: visibleItems, baseId: id, getId: function (_baseId, index) {
            ...
            if (item &&
                ...
                utils_1.scrollIntoView(container, item);
            }
            if (!multiSelect) {
                return;
            }
            ...
            switch (event.key) {
                ...
                case "ArrowRight":
                    ...
                    if (!expandedIds.includes(itemId)) {
                        ...
                        utils_1.scrollIntoView(event.currentTarget, nextItem);
                    }
                    break;
                case "ArrowLeft":
                    if (isParent && expandedIds.includes(itemId)) {
                        ...
                        utils_1.scrollIntoView(event.currentTarget, parentItem);
                    }
                    break;
                case "a": {
    ...
    var lastFocus = react_1.useRef(0);
    ...
    var handleFocus = react_1.useCallback(function (event) {
        ...
        if (currentItem && isKeyboard) {
            utils_1.scrollIntoView(getScrollContainer(event.currentTarget), currentItem);
        }
    ...
    var setActiveId = react_1.useCallback(function (itemId) {
